...
#else
vector freqs [] = {
  { 921000000, 125, 7, 10, 921000000, 500, 7, 12},
  { 922000000, 125, 7, 10, 922000000, 500, 7, 12},
  { 923000000, 125, 7, 10, 923000000, 500, 7, 12},    
};
#endif
...
//
struct pins {
	uint8_t dio0=27;	// GPIO15 / D8. For the Hallard board shared between DIO0/DIO1/DIO2
	uint8_t dio1=2;	// GPIO15 / D8. Used for CAD, may or not be shared with DIO0
	uint8_t dio2=4;	// GPIO15 / D8. Used for frequency hopping, don't care
...
struct pins {
  ...
  uint8_t dio2=4; // GPIO15 / D8. Used for frequency hopping, don't care
  uint8_t ss=15;    // GPIO16 / D0. Select pin connected to GPIO16 / D0
  uint8_t rst=0;		// GPIO14 / D3. Reset pin not used	
} pins;
#define SCK 14
#define MISO 12
#define MOSI 13
